...
const videoContainer = document.getElementById("mediaplayer");
...
const setVideoProgress = (event) => {
	console.log(event);
	const progress = event.offsetX / progressBar.offsetWidth;
	video.currentTime = Math.floor(video.duration * progress);
	console.log(Math.floor(video.duration * progress));
